...
<div class="pd-20">
    <form action="" method="post" class="form form-horizontal" id="form-teacher-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" value="" placeholder="" id="tPassword" name="tPassword"
                       datatype="*1-8" nullmsg="老师密码不能为空">
            </div>
            <div class="col-4"></div>
        </div>
        <div class="row cl">
