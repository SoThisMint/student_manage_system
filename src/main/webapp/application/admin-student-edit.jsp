...
<div class="pd-20">
    <form action="" method="post" class="form form-horizontal" id="form-student-edit">
        ...
        <div class="row cl">
            <label class="form-label col-3"><span class="c-red">*</span>学生姓名：</label>
            <div class="formControls col-5">
                <input type="text" class="input-text" placeholder="" id="sName" name="sName"
                       datatype="*1-8" nullmsg="学生名不能为空" value="${student.sName}">
            </div>
            <div class="col-4"></div>
        </div>
        <div class="row cl">
            <label class="form-label col-3"><span class="c-red">*</span>学生密码：</label>
            <div class="formControls col-5">
                <input type="text" class="input-text" placeholder="" id="sPassword" name="sPassword"
                       datatype="*1-8" nullmsg="学生密码不能为空" value="${student.sPassword}">
            </div>
            <div class="col-4"></div>
        </div>
        <div class="row cl">
