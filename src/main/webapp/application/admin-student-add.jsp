...
<div class="pd-20">
    <form action="" method="post" class="form form-horizontal" id="form-student-add">
        <div class="row cl">
            <label class="form-label col-3"><span class="c-red">*</span>学生名称：</label>
            <div class="formControls col-5">
                <input type="text" class="input-text" value="" placeholder="" id="sName" name="sName"
                       datatype="*1-8" nullmsg="学生名不能为空">
            </div>
            <div class="col-4"></div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" value="" placeholder="" id="sPassword" name="sPassword"
                       datatype="*1-8" nullmsg="学生密码不能为空">
            </div>
            <div class="col-4"></div>
        </div>
        <div class="row cl">
